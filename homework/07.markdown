...
# One Hand of Blackjack (Client Side JavaScript) - __Due Saturday, April 15th, by 11PM__
...
5. In your public folder, create a `stylesheets` folder and a file, `style.css`, within it (if you're using express-generator, these will be created for you)
...
(25 points) __Save results in database__
